...
#define GC_GRAPHICS_CREATE_DECL_WITH_SPEC2(x, y)                            \
	static ::GCrisp::Graphics::x* Create(const GC_CONCAT(y, Specification&) \
											 spec);
#define GC_GRAPHICS_CREATE_DECL_WITH_SPEC(x) \
	GC_GRAPHICS_CREATE_DECL_WITH_SPEC2(x, x)
...
#define GC_GRAPHICS_CREATE_IMPL(x)              \
	::GCrisp::Graphics::x* x::Create()          \
	{                                           \
...
#define GC_GRAPHICS_CREATE_IMPL_WITH_SPEC2(x, y)                              \
	::GCrisp::Graphics::x* x::Create(const GC_CONCAT(y, Specification&) spec) \
	{                                                                         \
		switch (GCrisp::Window::GetBackend()) {                               \
...
#define GC_GRAPHICS_CREATE_IMPL_WITH_SPEC(x) \
	GC_GRAPHICS_CREATE_IMPL_WITH_SPEC2(x, x)
